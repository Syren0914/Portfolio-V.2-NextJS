...
import { HandWrittenTitleDemo } from "./ui/handWrittenTitle";
...
function HeroSection() {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col-reverse gap-14 lg:gap-0 lg:flex-row items-center justify-between animate-move-up py-10">
      ...
      <div className="w-92 h-92 space-y-3  lg:absolute lg:right-36">
        <div>
          <Image
            className="rounded-full border-animation object-contain"
            src={heroimage}
            alt={"heroimage"}
            width={390}
            height={390}
      ...
      <Link href="/Erdene Batbayar (Transfer Resume).pdf" passHref>
